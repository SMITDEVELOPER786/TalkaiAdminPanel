...
import { user_buy_phone_post_async, user_get_phone_post_async } from "../../Store/Service/PhoneService";
...
function PhoneNumber() {
  ...
  const handleGetPhone = async (e) => {
    ...
    await dispatch(user_get_phone_post_async(post_data))
      .then((res) => {
        setPhoneData(res.payload.data);
      })
      .catch((e) => {
        console.log(e);
      });
...
const handleBuyPhone = async (number) =>{
 
const post_data = {
  Number:number
}

await dispatch(user_buy_phone_post_async(post_data))
.then((res)=>{
  console.log(res);
    ...
    <div className="">
      ...
      <header className="flex justify-between items-center px-4 my-4">
        ...
        <div className="flex-shrink-0">
          {" "}
          {/* Allows flexibility in space allocation */}
          <div className="flex items-center justify-between gap-2 border border-gray-500 rounded-full px-3 py-3 text-white">
            ...
            <span
              className="hidden md:inline-block text-sm px-2 cursor-pointer"
              onClick={openModal}
            >
              Get new number
            </span>{" "}
            {/* Hides text on smaller screens */}
          </div>
        </div>
      </header>
        ...
        <div className="w-full lg:w-[20%] border border-gray-500 rounded-md   ">
          <div className="flex items-center bg-[#171717] px-2 mx-2 justify-around p-2 group cursor-pointer hover:bg-[#55E3CB] my-2 rounded-md ">
            <div>
              ...
              <p className="text-[8px] text-center  group-hover:text-black-500 text-white">
                Ava
              </p>
            </div>

            <p className="text-white font-bold group-hover:text-black-500">
              +(234) 345 4374
            </p>
          </div>
          ...
          <div className="flex items-center bg-[#171717] px-2 mx-2 justify-around p-2 group cursor-pointer hover:bg-[#55E3CB] my-2 rounded-md ">
            ...
            <p className="text-white group-hover:text-black-500">
              +(234) 345 4374
            </p>
          </div>
        </div>
          ...
          <div className=" space-y-2">
            ...
            <div className="w-full flex  gap-x-3 items-center sm:flex-row flex-col rounded-md bg-[#26292E] p-2">
              <div className="w-full sm:w-[48%]">
                ...
                <p className="text-gray-300 text-xs pt-3">
            ...
            <div className="rounded-md bg-[#26292E] p-2">
              ...
              <div className="flex justify-between sm:flex-row flex-col  items-center mt-5">
                <div className="flex flex-wrap sm:gap-y-0  gap-y-3 items-center gap-x-1 sm:gap-x-2">
                  ...
                  <Icon
                    ...
                    className="bg-[#FE7E29] p-0.5 rounded"
                    height={"20"}
                    width={"20"}
                  />
                ...
                <p className="text-white text-xs mt-2 sm:mt-0">
                  Upload Number Count: 00
                </p>
              </div>
              ...
              <textarea
                ...
                cols="80"
                rows="5"
                className="bg-[#171717] w-full mt-2 rounded-md placeholder:text-sm placeholder:p-2"
                placeholder="Number you want to call"
              ></textarea>
                ...
                <div className="flex sm:flex-row flex-col gap-1 w-full">
                  <div className="sm:w-[55%] w-full">
                    ...
                    <input
                      ...
                      className="bg-[#171717] rounded-lg w-full  placeholder:px-2 placeholder:text-gray-500 p-1 placeholder:text-sm"
                    />
                  </div>
                  ...
                  <div class="sm:w-[55%] w-full ">
                    ...
                    <div className="flex items-center bg-[#171717] rounded-lg p-1 gap-x-1">
                      ...
                      <input
                        type="date"
                        class=" bg-transparent text-white  w-full placeholder:px-2 placeholder:text-gray-500   text-sm"
                      />
                    </div>
                  </div>
                  ...
                  <div class="sm:w-[55%] w-full ">
                    <button className="bg-[#FE7E29] w-[80%] mt-9 p-0.5 rounded">
                      Add
                    </button>
                  </div>
                </div>
              ...
              <div className="bg-[#171717] mt-2 flex p-2 sm:flex-row flex-col items-center rounded-md justify-between">
                ...
                <div class="  ">
                  <div className="flex items-center bg-[#171717] rounded-lg p-1 gap-x-1">
                    ...
                    <input
                      type="date"
                      class=" bg-transparent text-white  w-full placeholder:px-2 placeholder:text-gray-500   text-xs"
                    />
                  </div>
                </div>
              ...
              <button className="mt-5 float-right bg-[#FE7E29] px-4 text-sm py-2 rounded-md">
                Outbound call
              </button>
            </div>
                ...
                <Dialog.Panel className="w-full max-w-6xl border-[#55E3CB] border transform overflow-hidden rounded-2xl bg-[#26292E] p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-2">
                    <div className=" mt-2  flex-grow">
                      <select
                        className="bg-[#171717] rounded-lg w-full text-white text-sm outline-none p-2"
                        onClick={(e) => handleGetPhone(e)}
                      >
                              ...
                              <table className="min-w-full divide-y divide-gray-200 p-6">
                                <thead className="bg-gray-600 mb-6">
                                  <tr>
                                    <th
                                      scope="col"
                                      className="px-6 py-3 flex items-center gap-x-2 text-left text-xs font-medium text-white uppercase tracking-wider"
                                    >
                                      <Icon
                                        icon="vaadin:phone"
                                        color="#FE7E29"
                                    ...
                                    <th
                                      scope="col"
                                      className="pl-20 py-3 text-left text-xs font-medium text-white uppercase tracking-wider"
                                    >
                                      Order Now
                                    </th>
                                  </tr>
                                ...
                                <tbody className="my-6 divide-y divide-gray-200">
                                  {phoneData.map((v, i) => (
                                    <tr key={i} className="mb-7">
                                      ...
                                      <td className="px-6 py-4 whitespace-nowrap text-sm text-white">
                                        <div className="flex gap-x-2 items-center">
                                          ...
                                          <div className="bg-[#171717]  flex items-center">
                                            ...
                                            />
                                            <label
                                              className="h-7 w-7 mt-1 bg-black relative"
                                              htmlFor="agree"
                                            >
                                              {v.capabilities.voice == true ? (
                                                <Icon
                                                  icon="fa-solid:check"
                                      ...
                                      <td className="px-14 py-4 whitespace-nowrap text-sm text-white">
                                        \$0.00
                                      </td>
                                      <td className="px-10 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <button onClick={()=>handleBuyPhone(v.phoneNumber)} className="text-white bg-[#55E3CB] px-4 py-2 rounded">
                                          <Icon
                    ...
                    {/* <button
                      onClick={closeModal}
                      className="bg-[#55E3CB] px-3 py-1 mt-5 rounded-md float-right"
                    >
                      Create
                    </button> */}
                  </div>
