...
<Link to='/home/assistants'>
              <button
                type="button"
                className="relative inline-flex text-white w-full items-center justify-center rounded-full bg-[#55E2CA] px-3.5 py-2.5 font-semibold transition-all duration-200"
              >
              ...
              <p className='text-center text-white text-sm'>Don't have an account? <span className='text-[#55E2CA]'>Sign up</span></p>
            </div>
          </div>
        </div>
      </section>
